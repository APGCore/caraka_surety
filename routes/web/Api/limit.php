    ...
    ->group(function () {
        ...
        Route::controller(GuarantorProductTypeLimitController::class)
            ...
            ->name('guarantor-product-type-limit.')->group(function () {
                ...
                // NAME: api.limit-management.guarantor-product-type-limit.search-guarantor-product-type-limit
                // PATH : /api/limit-management/guarantor-product-type-limit/search-guarantor-product-type-limit
        ...
        Route::controller(ProfileLimitController::class)
            ...
            ->name('profile-limit.')->group(function () {
                ...
                // NAME: api.limit-management.profile-limit.search-profile-limit
                // PATH : /api/limit-management/profile-limit/search-profile-limit
        ...
        Route::controller(EmployeeLimitController::class)
            ...
            ->name('employee-limit.')->group(function () {
                ...
                // NAME: api.limit-management.employee-limit.search-employee-limit
                // PATH : /api/limit-management/employee-limit/search-employee-limit
