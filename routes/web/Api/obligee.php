    ...
    ->group(function () {
        ...
        Route::controller(ObligeeController::class)
            ...
            ->group(function () {
                ...
                // NAME: api.obligee-management.obligee.search-obligee-by-name
                // PATH: /obligee-management/obligee/search-obligee-by-name
                Route::get('search-obligee-by-name', 'apiSearchByName')->name('search-by-name');
            });
    });
