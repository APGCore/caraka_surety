...
import { staffCabangRoute } from "./StaffCabangLayout.constant";
import { StaffCabangLayoutPageProps } from "./StaffCabangLayout.type";
...
export const StaffCabangLayoutPage: StaffCabangLayoutPageProps = ({ children, user }) => {
  ...
  return (
    <SidebarProvider>
      <AppSidebar user={user} routes={staffCabangRoute} />
      <SidebarInset>
