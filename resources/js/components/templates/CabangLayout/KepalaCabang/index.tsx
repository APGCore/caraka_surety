...
import { kepalaCabangRoute } from "./KepalaCabangLayout.constant";
import { KepalaCabangLayoutPageProps } from "./KepalaCabangLayout.type";
...
export const KepalaCabangLayoutPage: KepalaCabangLayoutPageProps = ({ children, user }) => {
  ...
  return (
    <SidebarProvider>
      <AppSidebar user={user} routes={kepalaCabangRoute} />
      <SidebarInset>
