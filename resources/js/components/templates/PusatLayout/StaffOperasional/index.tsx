...
import { staffOperasionalRoute } from "./StaffOperasionalLayout.constant";
import { StaffOperasionalLayoutPageProps } from "./StaffOperasionalLayout.type";
...
export const StaffOperasionalLayoutPage: StaffOperasionalLayoutPageProps = ({ children, user }) => {
  ...
  return (
    <SidebarProvider>
      <AppSidebar user={user} routes={staffOperasionalRoute} />
      <SidebarInset>
