      ...
      <table style={{ width: "100%", borderCollapse: "collapse", lineHeight: "1.5" }}>
        <tbody>
          ...
          <tr>
            ...
            <td style={{ textAlign: "justify" }}>
              Perusahaan memiliki kondisi keuangan {financialCondition}. Laporan keuangan menunjukkan laba bersih
              sebesar {netProfit} pada tahun terakhir {financialYear}.
            </td>
          </tr>
          <tr>
            <td style={{ verticalAlign: "top" }}>3.</td>
            <td style={{ textAlign: "justify" }}>
              {companyName} juga memiliki pengalaman {projectExperience}, termasuk proyek dengan nilai kontrak{" "}
              {contractValue}.
            </td>
          </tr>
          <tr>
