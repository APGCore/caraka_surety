...
import { KepalaAgentPartnerDashboardPageProps } from "./kepala-agent-partner-dashboard-page.type";
import { DashboardUtils } from "./kepala-agent-partner-dashboard-page.utils";

const KepalaAgentPartnerDashboardPage: KepalaAgentPartnerDashboardPageProps = ({
    total_submission,
...
export default KepalaAgentPartnerDashboardPage;

KepalaAgentPartnerDashboardPage.layout = (page: any) => {
