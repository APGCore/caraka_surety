...
<table style="width: 100%; border-collapse: collapse; line-height: 1.5;">
    <tr>
        ...
        <td style="text-align: justify;">Kami yang bertanda tangan di bawah ini: PT. ASURANSI UMUM VIDEI [NAMA_PENJAMIN], berkantor di Graha Mustika Ratu, Jl. Jend. Gatot Subroto, Jakarta (ALAMAT PENJAMIN), selanjutnya disebut sebagai PENJAMIN, menyatakan dengan ini menjamin kewajiban PT. MOTI BATARA ALKESINDO (NAMA PRINCIPAL), berkantor di Jl. Agave Raya Blok A1 No. 19A, Jakarta Barat (ALAMAT PRINCIPAL), selanjutnya disebut sebagai PRINCIPAL, terhadap PT. POLITEKNIK KESEHATAN JAKARTA III (NAMA OBLIGEE), berkantor di Jl. Arteri JORR, Bekasi (ALAMAT OBLIGEE), yang selanjutnya disebut sebagai OBLIGEE.</td>
    </tr>
    <tr>
        <td style="vertical-align: top;">2.</td>
        <td style="text-align: justify;">PENJAMIN bertanggung jawab untuk membayar kepada OBLIGEE sejumlah Rp. 34.000.000 [BESARAN_NILAI_JAMINAN] dalam hal PRINCIPAL gagal memenuhi kewajibannya dalam menyelesaikan Pekerjaan Pengadaan Alat Laboratorium Politeknik Kesehatan Jakarta III (NAMA PEKERJAAN) sesuai dengan ketentuan dalam kontrak Nomor KN.01.01/V/6747/2019 (NOMOR KONTRAK) tanggal 30 September 2019 (TANGGAL KONTRAK).</td>
    </tr>
    <tr>
        <td style="vertical-align: top;">3.</td>
        <td style="text-align: justify;">Jaminan ini berlaku efektif sejak tanggal 01 Oktober 2019 dan berakhir pada 29 Desember 2019 [MASA_BERLAKU], atau sampai dengan berakhirnya masa pemeliharaan yang telah disepakati dalam kontrak, mana yang lebih lama.</td>
    </tr>
    <tr>
...
<table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
    ...
    <tr>
        <td style="text-align: left;">PT. ASURANSI UMUM VIDEI [NAMA_PENJAMIN]</td>
    ...
    <tr>
        <td style="text-align: left;">
            Muhammad Ridzqan Hanafis [NAMA_PENANGGUNG_JAWAB_PENJAMIN]<br>
            Direktur [JABATAN_PENJAMIN]
        </td>
        <td style="text-align: right;">
            Marthen F Surentu [NAMA_KEPALA_CABANG]<br>
            Kepala Cabang
        </td>
    </tr>
</table>
