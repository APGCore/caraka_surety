const templatePemeliharaan = `
<h2 style="text-align: center;">JAMINAN PEMELIHARAAN</h2>
...
<table style="width: 100%; border-collapse: collapse; line-height: 1.5;">
    <tr>
        ...
        <td style="text-align: justify;">Dengan ini dinyatakan, bahwa kami : [PRINCIPAL_NAME], sebagai Penyedia, selanjutnya disebut TERJAMIN, dan [GUARANTOR_NAME], [GUARANTOR_LOCATION] sebagai Penjamin, selanjutnya disebut PENJAMIN, bertanggung jawab dan dengan tegas terikat pada [OBLIGEE_NAME], selaku Pemilik Pekerjaan, selanjutnya disebut PENERIMA JAMINAN atas uang sejumlah [GUARANTEE_VALUE].</td>
    </tr>
    <tr>
        <td style="vertical-align: top;">2.</td>
        <td style="text-align: justify;">Maka kami, TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut di atas dengan baik dan benar bilamana TERJAMIN tidak memenuhi kewajiban dalam melaksanakan pekerjaan [JOB_NAME] yang telah dipercayakan kepadanya atas dasar Berita Acara Serah Terima Hasil Pekerjaan (PHO) tanggal [CONTRACT_DOC_DATE].</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="text-align: justify;">Surat Jaminan ini berlaku apabila TERJAMIN tidak memenuhi kewajibannya melakukan pemeliharaan sebagaimana ditentukan dalam Dokumen Kontrak.</td>
    </tr>
    <tr>
...
<table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
    <tr>
        <td style="text-align: left;">Dikeluarkan di [ISSUE_LOCATION]</td>
...
export default templatePemeliharaan;
