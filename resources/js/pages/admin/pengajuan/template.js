...
<ol>
    ...
    <li>
        <p>Maka kami, TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut di atas dengan baik dan benar bilamana TERJAMIN tidak memenuhi kewajiban dalam melaksanakan pelelangan Pekerjaan Pengadaan Alat Laboratorium Jurusan Keperawatan Poltekkes Kemenkes Jakarta III(NAMA PEKERJAAN) yang telah dipercayakan kepadanya atas dasar Surat Penunjukan Penyedia Barang/Jasa (SPPBJ)(NAMA DOKUMEN) Nomor : KN.01.01/V/6747/2019(NOMOR DOKUMEN) tanggal 30 September 2019(TANGGAL DOKUMEN).</p>
    </li>
    <li>
        <p>Surat Jaminan ini berlaku selama 90 (Sembilan Puluh) hari kalender dan efektif mulai dari 01 Oktober 2019 sampai dengan tanggal 29 Desember 2019(JANGKA WAKTU).</p>
    </li>
    <li>
        <p>Jaminan ini berlaku apabila:</p>
        <ul>
    ...
    <li>
        <p>PENJAMIN akan membayar kepada PENERIMA JAMINAN sejumlah nilai jaminan tersebut di atas dalam waktu paling lambat 14 (empat belas) hari kerja tanpa syarat setelah menerima tuntutan pencairan secara tertulis dari PENERIMA JAMINAN berdasar Keputusan PENERIMA JAMINAN mengenai pengenaan sanksi akibat TERJAMIN cidera janji.</p>
    </li>
    <li>
        <p>Menunjuk pada Pasal 1832 KUH Perdata dengan ini ditegaskan kembali bahwa PENJAMIN melepaskan hak-hak istimewa untuk menuntut supaya harta benda TERJAMIN lebih dahulu disita dan dijual guna dapat melunasi hutangnya sebagaimana dimaksud dalam Pasal 1831 KUH Perdata.</p>
    </li>
    <li>
