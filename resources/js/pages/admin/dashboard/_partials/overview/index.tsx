    ...
    <div className="space-y-4">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{props.totalSubmission}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Premi</CardTitle>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <CardContent>
            <div className="text-xl font-bold">
              {formatStringWithDots(formatCurrency(Number(props.totalPremi)), 17)}
            </div>
          </CardContent>
        </Card>
        <Card>
