...
const BranchBankHeader: React.FC<Props> = ({ title, button }) => {
  return (
    <>
      ...
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink href={route(BankUtils.link.index)}>{title ?? "Bank"}</BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
...
export default BranchBankHeader;
