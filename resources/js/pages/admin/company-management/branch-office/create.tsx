...
const BranchOfficeCreatePage: React.FC<BranchOfficeFormPageProps> & { layout?: any } = ({
  provinces,
  regencies,
  districts,
}) => {
  return (
    <main className="space-y-2.5 flex items-center justify-center">
      <div className="max-w-xl w-full">
        <UpdateProfileBprInformation provinces={provinces} regencies={regencies} districts={districts} />
      </div>
    </main>
  );
};
