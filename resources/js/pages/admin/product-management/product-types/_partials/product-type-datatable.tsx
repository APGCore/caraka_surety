...
interface ProductTypeDatatableProps {
    productTypes: any;
    onDelete: (product: any) => void;
}

const ProductTypeDatatable: React.FC<ProductTypeDatatableProps> = ({ productTypes, onDelete }) => {
    return (
        <>
            <Table>
                <TableHeader>
                ...
                <TableBody>
                    <RenderList
                        ...
                        render={(productType: any, index: number) => (
            ...
            <PaginationDatatable meta={productTypes?.meta} only={["productTypes"]} />
        </>
    );
};
