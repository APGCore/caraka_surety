        ...
        if (isEdit) {
            axios
                ...
                .then(() => {
                    ...
                    handleCloseForm();
                    router.get(
                        route(FormSkoringQuestionCategoryUtils.fallback.route.index) +
                            `?scoring_id=${dataForm.scoring_id}`,
                        {},
                    );
                })
                .catch((error) => {
        ...
        <AlertDialog open={isOpenForm} onOpenChange={setIsOpenForm}>
            <AlertDialogTrigger asChild>
                <Button
                    ...
                    {isEdit
                        ...
                        : FormSkoringQuestionCategoryUtils.create.title}
                </Button>
            </AlertDialogTrigger>
            <AlertDialogContent className="w-[400px] space-y-3">
                <AlertDialogHeader className="space-y-1">
                    <AlertDialogTitle>
                        {isEdit
                            ? FormSkoringQuestionCategoryUtils.edit.title
                            : FormSkoringQuestionCategoryUtils.create.title}
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                        {isEdit
