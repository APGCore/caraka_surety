...
const ProductGuarantorPage: ProductGuarantorPageProps = ({ guarantors, products, jobGroups, jobTypes }) => {
    ...
    const removeProduct = async (product: any) => {
        try {
            ...
            const newProductTypeOwnedProduct = productTypeOwnedProduct.filter(
                (data: any) => data.product_id !== product.id,
            );
                ...
                <div className="border p-8 rounded-md shadow-md">
                    <div className="flex items-center mb-4 space-x-2">
                        <h2 className="text-xl">
                            {guarantors.find((item: any) => item.id == guarantorSelected)?.name}
                        </h2>
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        Data yang belum disimpan akan terhapus!!!.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                                        ...
                                                        <Select
                                                            ...
                                                            <SelectContent>
                                                                <SelectGroup>
                                                                    ...
                                                                    <RenderList
                                                                        of={jobGroups}
                                                                        render={(jobGroup: string) => (
                                                                            <SelectItem value={jobGroup}>
                                                                                {jobGroup}
                                                                            </SelectItem>
                                                                        )}
                                                                    />
