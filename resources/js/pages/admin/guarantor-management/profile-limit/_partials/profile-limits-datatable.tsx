                        ...
                        render={(profile: any, index: number) => (
                            <TableRow key={profile.id}>
                                ...
                                <TableCell className="text-right">
                                    {(!guarantorSelectedId &&
                                        <div className="text-center">Pilih Penjamin terlebih dahulu</div>) || (
                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <Button variant="ghost"
                                                        className="flex h-8 w-8 p-0 group data-[state=open]:bg-zinc-500">
                                                    <DotsHorizontalIcon
                                                        className="h-4 w-4 group-data-[state=open]:text-white" />
                                            ...
                                            <DropdownMenuContent className="w-36 mr-8 mt-1">
                                                ...
                                                <Show when={profile.profile_limit}>
                                                    <DropdownMenuSeparator />
