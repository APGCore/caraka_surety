                                ...
                                render={(profile: any, index) => {
                                    return (
                                        <TableRow key={profile.id}>
                                            ...
                                            <TableCell>
                                                {profile?.users_count === 0 ? "-" : Number(profile?.users_count)}
                                            </TableCell>
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent className="w-36 mr-8 mt-1">
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            onSelect={(e) => e.preventDefault()}>
                                                            <Link
                                                                href={route("branch-mitra-agen.employee.index", {
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            onSelect={(e) => e.preventDefault()}>
                                                            <Link
                                                                href={route("branch-mitra-agen.edit", profile.id)}
                                                            ...
                                                            <AlertDialog>
                                                                ...
                                                                <AlertDialogContent>
                                                                    <AlertDialogHeader>
                                                                        ...
                                                                        <AlertDialogDescription>
                                                                            Tindakan ini akan menghapus data Cabang{" "}
                                                                            {profile.name}?
                                                                        </AlertDialogDescription>
                                                                    </AlertDialogHeader>
                                                                    <AlertDialogFooter>
