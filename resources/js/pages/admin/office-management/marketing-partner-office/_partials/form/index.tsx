...
import Label from "@/components/molecules/input/label-input";
import Input from "@/components/molecules/input/text-input";
    ...
    return (
        <form onSubmit={handleSubmitForm} className="mt-6 space-y-10">
            <div className="grid gap-1 ">
                <p className="text-xl font-bold">Data Kantor Mitra Pemasaran</p>
            ...
            <div className="grid gap-1 ">
                <p className="text-xl font-bold">Lokasi Kantor Mitra Pemasaran</p>
                <div className="grid gap-5 mt-2">
                    <div className="flex gap-5">
                ...
                <div className="space-y-10">
                    ...
                    <RenderList
                        ...
                        render={(guarantor, guarantorIndex) => {
                            return (
                                <div
                                    key={guarantorIndex + 1}
                                    className="space-y-3 flex flex-col items-end border rounded-md p-2">
                                        ...
                                        <RenderList
                                            ...
                                            render={(branchGuarantor, branchGuarantorIndex) => (
                                                <div key={branchGuarantorIndex} className="flex">
                                                    <span className=" text-3xl w-[10%] flex justify-center items-center">
                                                        -
                                                    </span>
