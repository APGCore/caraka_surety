...
const Form: React.FC<Props> = ({ branchOffice, routeSubmit, routeBack, type }) => {
  ...
  return (
    <form onSubmit={submit} className="mt-6 space-y-6">
      ...
      <div>
        <Label htmlFor="postal_code" value="Kode Pos" />
        ...
        <Input
          ...
          min="0"
          placeholder="Masukan Kode Pos Cabang"
        />

        <InputError className="mt-2" message={errors.postal_code} />
      </div>

      <div className="border p-6 space-y-8">
        <h1 className="text-2xl font-bold">Pairing Asuransi</h1>
