import EditOfficePage from "@/_features/office/pages/edit-office-page";
...
const BranchOfficeEditPage: BranchOfficeEditPageProps = ({ office }) => {
  return <EditOfficePage office={office} />;
  // return (
