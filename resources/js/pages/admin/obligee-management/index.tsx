...
import { ObligeeManagementPageProps } from "./obligee-management-page.type";

const ObligeeManagementPage: ObligeeManagementPageProps = ({ obligees }) => {
  ...
  return (
    <main className="space-y-2.5">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Nama Obligee</TableHead>
      ...
      <div className="text-sm text-gray-500">
        Menampilkan {obligees.length > 0 ? 1 : 0} sampai {obligees.length} dari {obligees.length} hasil
      </div>
      <Pagination>
        <PaginationContent>
          <PaginationItem>
  ...
  return (
    <AdminLayout user={pagePropsData?.auth?.user}>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href={route("obligee.create")}>Tambah Obligee</Link>
        </Button>
      </div>
      {page}
    </AdminLayout>
