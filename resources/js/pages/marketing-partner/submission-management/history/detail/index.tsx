    ...
    const handleAutoSave = debounce(
        async ({ editorId, submissionId, content }: AutoSaveParams) => {
            try {
                ...
                console.log(
                    `Auto-saved for editor "${editorId}" (submission ID: ${submissionId}). Response:`,
                    response.data,
                );
            } catch (error) {
                ...
                <div>
                    <Alert
                        ...
                        <AlertDescription>
                            <Show when={isProcess}>
                                <span>
                                    Pengajuan sedang diproses {submission?.checked_at && "dan menunggu persetujuan"}
                                </span>
                            </Show>
                                    ...
                                    <td
                                        ...
                                        calculateTotalPoint(submission?.scores) ? (
                                            <span className="text-green-800">
                                                Disetujui Karena Nilai {calculateTotalPoint(submission?.scores)} Lebih
                                                Dari {submission?.scores?.[0]?.scoring?.min_point}
                                            </span>
                                        ) : (
