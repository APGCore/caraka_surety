...
const SubmissionDetailPage: SubmissionDetailPageProps = ({ submission }) => {
    ...
    const dataTemplate: SubmissionData = {
        ...
        underlying:
            submission.contract_doc_name + " " + submission.contract_doc_number + " " + submission.job_name || "",
    ...
    const documentFormat = () => {
        return Object.keys(editorRefs.current).map((key) => {
            const allDocuments = [
                ...
                ...(Array.isArray(submission.document_format_type_guarantee)
                    ? submission.document_format_type_guarantee
                    : []),
            ];
        ...
        <>
            <Show when={submission.beyond_the_limit}>
                <div className="fixed top-20 w-[73vw] z-[100]">
                    <Alert variant="destructive">
                        ...
                        <AlertDescription>
                            Pengajuan Melebihi Batas Kewenangan Nilai Jaminan Rp.{" "}
                            {textCurrency(submission.guarantee_value)}
                        </AlertDescription>
                    </Alert>
                </div>
            </Show>
            ...
            <main className={"space-y-10 w-[800px] mx-auto mt-[50px]"}>
                            ...
                            <AlertDescription>
                                <Show when={isProcess}>
                                    <span>
                                        ...
                                        {submission.checked_at && "dan telah di kirim ke Direksi"}
                                    </span>
                                </Show>
                                ...
                                <thead>
                                    <tr className="border-b bg-gray-100">
                                        ...
                                        <RenderList
                                            ...
                                            render={(ratio: any) => {
                                                return (
                                                    <th className="p-2 font-semibold text-center w-1">{ratio.year}</th>
                                                );
                                            }}
                                        />
                                    </tr>
                                    ...
                                    <tr className="border-b">
                                        ...
                                        <RenderList
                                            ...
                                            render={(ratio: any) => {
                                                return (
                                                    <td className="p-2 font-semibold text-center w-1/2">
                                                        {formatCurrency(ratio.current_debt)}
                                                    </td>
                                                );
                                            }}
                                        />
                                    ...
                                    <tr className="border-b">
                                        ...
                                        <RenderList
                                            ...
                                            render={(ratio: any) => {
                                                return (
                                                    <td className="p-2 font-semibold text-center w-1/2">
                                                        {formatCurrency(ratio.total_debt)}
                                                    </td>
                                                );
                                            }}
                                        />
                                    ...
                                    <tr className="border-b">
                                        ...
                                        <RenderList
                                            ...
                                            render={(ratio: any) => {
                                                return (
                                                    <td className="p-2 font-semibold text-center w-1/2">
                                                        {formatCurrency(ratio.total_assets)}
                                                    </td>
                                                );
                                            }}
                                        />
                                    ...
                                    <tr className="border-b">
                                        ...
                                        <RenderList
                                            ...
                                            render={(ratio: any) => {
                                                return (
                                                    <td className="p-2 font-semibold text-center w-1/2">
                                                        {formatCurrency(ratio.net_income)}
                                                    </td>
                                                );
                                            }}
                                        />
                                ...
                                <tbody>
                                    {Object.entries(
                                        submission.scores.reduce((grouped: any, score: any) => {
                                            const { scoring_question_category_id, scoring_question_category, ...rest } =
                                                score;
                                            if (!grouped[scoring_question_category_id]) {
                                                grouped[scoring_question_category_id] = {
                                                    ...scoring_question_category,
                                            ...
                                            <React.Fragment key={id}>
                                                ...
                                                <tr className="bg-gray-50">
                                                    ...
                                                    <td className="p-2 text-center">
                                                        {scores.items.reduce(
                                                            (total: number, score: any) => total + score.point,
                                                            0,
                                                        )}
                                                    </td>
                                                </tr>
                                        ...
                                        <td
                                            ...
                                            calculateTotalPoint(submission.scores) ? (
                                                <span className="text-green-800">
                                                    Disetujui Karena Nilai {calculateTotalPoint(submission.scores)}{" "}
                                                    Lebih Dari {submission.scores?.[0]?.scoring?.min_point}
                                                </span>
                                            ) : (
                                        ...
                                        <div className="flex flex-col items-center justify-center py-4">
                                            {submission.callback ? (
                                                <>
                                                    ...
                                                    <Button
                                                        onClick={() =>
                                                            window.open(submission.callback.doc_url, "_blank")
                                                        }>
                                                        Dokumen Pendukung
                                                    </Button>
                                                </>
                ...
                {!spkmgrFile && <p className="text-red-500 text-sm mt-2">File SPKMgr belum diunggah.</p>} */}
                            ...
                            <div className="mb-4">
                                <h3 className="text-lg font-semibold mb-2">
                                    Upload File Permohonan yang Ditandatangani
                                </h3>
                ...
                {!permohonanFile && <p className="text-red-500 text-sm mt-2">File Permohonan belum diunggah.</p>} */}
                                        ...
                                        render={(docSig) => (
                                            <tr key={docSig.id} className="border-b">
                                                <td className="p-2" title={docSig.name}>
                                                    {docSig.name.length > 30
                                                        ? `${docSig.name.slice(0, 30)}...`
                                                        : docSig.name}
                                                </td>
                                                <td className="p-2">
                                                    {docSig?.url ? (
                                                        <PreviewFile preview={docSig.url} />
                                                    ) : (
                                                        "File Belum Diunggah"
                                                    )}
                                                </td>
                                ...
                                {(() => {
                                            ...
                                            documentsToDisplay.push(
                                                <div key={doc.id} style={{ marginBottom: "20px" }}>
                                                    ...
                                                    <TinyMCEEditor
                                                        ...
                                                        onInit={(evt, editor) =>
                                                            (editorRefs.current[`editor-${doc.id}`] = editor)
                                                        }
                                                    />
                                                </div>,
                                            );
                                    ...
                                    return (
                                        <p className="text-gray-500">
                                            Tidak ada dokumen yang tersedia untuk ditampilkan.
                                        </p>
                                    );
                                })()}
                            </div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            <AlertDialogTitle>
                                                Apakah Anda Yakin ingin menyetujui pengajuan ini dan Kirim Ke{" "}
                                                {submission.guarantor?.name}?
                                            </AlertDialogTitle>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
                                            <AlertDialogCancel>Batal</AlertDialogCancel>
                        ...
                        <Show
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        <AlertDialogTitle>
                                            Apakah Anda Yakin ingin mengirimkan pengajuan ini ke direksi?
                                        </AlertDialogTitle>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>Batal</AlertDialogCancel>
                        ...
                        <Show
                            when={submission.status === SubmissionStatus.APPROVED && !submission.has_send_to_guarantor}>
                            <AlertDialog>
                                <AlertDialogTrigger asChild>
                                    <Button
                                        variant="default"
