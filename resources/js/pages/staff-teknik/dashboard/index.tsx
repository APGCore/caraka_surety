...
import { StaffTeknikDashboardPageProps } from "./staff-teknis-dashboard-page.type";

const StaffTeknikDashboardPage: StaffTeknikDashboardPageProps = ({
  total_submission,
...
export default StaffTeknikDashboardPage;

StaffTeknikDashboardPage.layout = (page: any) => {
