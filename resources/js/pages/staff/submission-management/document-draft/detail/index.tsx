    ...
    useEffect(() => {
        ...
        const setupEditors = () => {
            ...
            const setupEditor = (selector: string, editorId: string, template: string) => {
                ...
                if (editorElement) {
                    ...
                    window.tinymce.init({
                        ...
                        toolbar:
                            "undo redo | bold italic | alignleft aligncenter alignright | code | exportToWordButton",
                        promotion: false,
                        branding: false,
                        setup: (editor: any) => {
            ...
            setupEditor(
                "#surat-pelaksanaan",
                "surat-pelaksanaan",
                replacePelaksanaanPlaceholders(templatePelaksanaan, data),
            );
            setupEditor(
                "#surat-permohonan",
                "surat-permohonan",
                replacePermohonanPlaceholders(templatePermohonan, data),
            );
