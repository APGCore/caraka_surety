                ...
                px-2 py-1.5 text-sm w-full rounded-sm text-start"
                                ...
                                <AlertDialogContent className={"w-max"}>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Silakan masukan jumlah blangko yang akan di bagikan
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <div className="flex items-center gap-2">
                                        Blangko Tersedia: {blankNotUsed.length}
                                    </div>
                                ...
                                <AlertDialogContent className={"w-max"}>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-end justify-around mt-6 space-x-2">
                                            ...
                                            <ArrowRight className="mb-2" />
                                            <Combobox
                                                datas={officeForTransfer.filter(
                                                    (office: any) => office.id !== fromOffice?.id,
                                                )}
                                                labelKey={"name"}
                                                valueKey={"name"}
                ...
                <Select
                    ...
                    <SelectContent>
                        <SelectGroup>
                            <RenderList
                                of={officeTypes}
                                render={(officeType: string) => (
                                    <SelectItem value={officeType}>{officeType}</SelectItem>
                                )}
                            />
                        </SelectGroup>
                    </SelectContent>
                                ...
                                <TableRow key={blank.id}>
                                            ...
                                            <Checkbox
                                                ...
                                                onCheckedChange={(value) => {
                                                    if (value) {
                                                        ...
                                                        setSelectedBlanks(
                                                            selectedBlanks.filter((item) => item.id !== blank.id),
                                                        );
                                                    }
                                                }}
                                    ...
                                    <TableCell className="space-x-1">
                                        ...
                                        <Show when={blank.from_profile_id}>
                                            <Badge className="text-white bg-blue-400">
                                                Di Transfer Dari {blank.from_profile?.name}
                                            </Badge>
                                        </Show>
                                    </TableCell>
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        Tindakan ini akan menghapus data blangko dari{" "}
                                                        {blank?.profile?.name}?
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
