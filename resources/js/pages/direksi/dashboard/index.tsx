...
import { DireksiDashboardPageProps } from "./direksi-dashboard-page.type";
import { Overview } from "./partials/overview";
import { RecentSales } from "./partials/recent-sales";

const DireksiDashboardPage: DireksiDashboardPageProps = ({
    total_submission,
...
export default DireksiDashboardPage;

DireksiDashboardPage.layout = (page: any) => {
