...
import { StaffCabangDashboardPageProps } from "./staff-cabang-dashboard-page.type";

const StaffCabangDashboardPage: StaffCabangDashboardPageProps = () => {
  return (
...
export default StaffCabangDashboardPage;

StaffCabangDashboardPage.layout = (page: any) => {
