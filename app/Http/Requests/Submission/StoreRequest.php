...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // if ($this->get('submissionType') == SubmissionType::NEW->value && $this->get('submission.product_type_id') != 1) {
        ...
        return [
            ...
            'submission.revised_note' => ['required_if:submissionType,'.SubmissionType::REVISION->value, 'nullable', 'string'], // catatan
    ...
    public function messages(): array
    {
        return [
            ...
            'submission.contract_value.regex' => 'Nilai kontrak tidak valid',
            'submission.guarantee_value.required' => 'Nilai jaminan wajib diisi',
            'submission.guarantee_value.regex' => 'Nilai jaminan tidak valid',
