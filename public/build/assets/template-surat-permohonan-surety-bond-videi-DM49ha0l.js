import{r as t}from"./app-CD3kv2xt.js";const m="/build/assets/jastan-BYYHO1xn.jpg",y=a=>{const[n,r]=t.useState(()=>a),[o,l]=t.useState(()=>a[0].name),s=t.useCallback(e=>{const A=n.findIndex(i=>i.name===e),b=n.map((i,g)=>({...i,isActive:g<=A}));r(b)},[]),p=t.useCallback(e=>{l(e),s(e),window.scrollTo({top:0,behavior:"smooth"})},[s]),d=t.useCallback(()=>{r(a),l(a[0].name)},[a]);return{currentStep:o,steps:n,gotoStep:p,resetSteps:d}},u=a=>new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR"}).format(Number(a)),P=`
