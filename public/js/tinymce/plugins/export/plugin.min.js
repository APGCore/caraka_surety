...
!(function () {
  ...
  const e = (e) => parseInt(e, 10),
    ...
    r = (e, t, r) => ({ major: e, minor: t, patch: r }),
    o = (t) => {
  ...
  const f = Array.prototype.indexOf,
    ...
    O = (e) => {
      const t = ((e) =>
        "ImageProxy HTTP error: " + x(k, (t) => e === t.code).fold(p("Unknown ImageProxy error"), (e) => e.message))(e);
      ...
      return P(
        ...
        return e.ok
          ...
          : ((e, t) =>
                ...
                (400 === e || 403 === e || 404 === e || 500 === e))((t = e.status), (r = e.blob))
            ? ((e) =>
                ((e) =>
                  new Promise((t, r) => {
    ...
    T = U("export_formats"),
    A = U("export_ignore_elements"),
    N = U("export_image_proxy_max_in_flight"),
    E = U("content_style"),
    F = U("content_css_cors"),
    L = (e) =>
      new Promise((t) => {
          ...
          s.addNodeFilter("img", (t) => {
            _(t, (t) => {
              ...
              ((e, t) =>
                0 === t.indexOf("data:") ||
                0 === t.indexOf("blob:") ||
                new tinymce.util.URI(t).host === e.documentBaseURI.host)(e, o) ||
                ((e, t) => {
                  return (
                    (r = ((e) => {
                      var t, r;
                      return null !==
                        (r =
                          null !== (t = e.options.get("export_cors_hosts")) && void 0 !== t
                            ? t
                            : e.options.get("editimage_cors_hosts")) && void 0 !== r
                        ? r
                        : [];
                    })(e)),
                ...
                ((s = n), (i = r), ((e, t) => w.call(e, t))(s, i) ? y.from(s[i]) : y.none()).fold(
                  () => (n[o] = [t]),
                  (e) => (n[r] = e.concat(t)),
                );
            });
          });
          const i = s.parse(t, { forced_root_block: !1, isRootContent: !0 }),
            a = ((e, t) => {
              const r = [],
                o = () => {
                  y.from(r.shift()).fold(
              ...
              return (...n) =>
                (0 === e ? new Promise((e) => r.push(e)) : ((e -= 1), Promise.resolve()))
                  .then(() => t(...n))
                  .then(
                    (e) => (o(), e),
                    (e) => (o(), Promise.reject(e)),
                  );
            })(N(e), (t) =>
              ((e, t, r = !0) =>
                t
                  ? S(e, t)
                  : ((e, t) => P(e, {}, t).then((e) => (e.ok ? Promise.resolve(e.blob) : O(e.status))))(e, r))(
                ((e, t) => e + (-1 === e.indexOf("?") ? "?" : "&") + "url=" + encodeURIComponent(t))(r, t),
                o,
                !0,
              ).then(L, (t) => (e.notificationManager.open({ type: "error", text: t }), tinymce.Env.transparentSrc)),
            );
          return Promise.all(v(b(n), (e) => a(e).then((t) => ({ orig: e, base64: t })))).then(
            (t) => (
              _(t, (e) => {
                _(n[e.orig], (t) => {
                  t.attr("src", e.base64);
              ...
              tinymce.html.Serializer({ validate: !0 }, e.schema).serialize(i)
            ),
          );
        })
    ...
    B = (e) => {
      ...
      return ((e, t, r) => {
        ...
        const n = o.parse(t, { forced_root_block: !1, isRootContent: !0 });
        return tinymce.html.Serializer({ validate: !0 }, e.schema).serialize(n);
      })(e, t, A(e));
    },
    D = (e) => {
      const t = e.dom.encode,
        r = F(e) ? 'crossorigin="anonymous"' : "",
        o = y.from(E(e)).map((e) => `<style type="text/css">${e}</style>`);
      return v(
        e.contentCSS,
        (o) => `<link type="text/css" rel="stylesheet" href="${t(e.documentBaseURI.toAbsolute(o))}" ${r}>`,
      )
        .concat(o.toArray())
        .join("\n");
    };
  ...
  const $ = (e) => {
      ...
      ((e, t) => {
        ...
        ((e, t, r) => {
          ((e, t, r) => {
            if (!i(r))
              throw (
                (console.error("Invalid call to CSS.set. Property ", t, ":: Value ", r, ":: Element ", e),
        ...
        ((e) => {
          ...
          return q(t);
        })(q(document)).dom.appendChild(n.dom),
        o.dom.click(),
        ((e) => {
          const t = e.dom;
    ...
    K = (e, t, r) => {
      ...
      return tinymce.Resource.load("export.exporter." + r, o)
        .then((t) =>
          t(
            e,
            ((e) => ({ downloadAs: V, getContent: h(B, e), utils: { getStyles: h(D, e), proxyImages: h(M, e) } }))(e),
          ),
        )
        .catch((t) => (console.error(t), Promise.reject(e.translate(['Failed to load the "{0}" exporter', r]))));
    },
    H = (e, t, r, o) => {
      ...
      return (
        ...
        K(e, t, r)
          .then((e) => o(e).then(e.download))
          .then(n, (t) => {
            n(), e.notificationManager.open({ type: "error", text: t });
          })
      );
    };
        ...
        !((e, r) =>
          ...
          -1 ===
            ((e, r) => {
              ...
              ((e) => o(((e) => [e.majorVersion, e.minorVersion].join(".").split(".").slice(0, 3).join("."))(e)))(e),
              o(r),
            ))(tinymce, "6.0.0")
      )
        return (
          ((e) => {
            const t = e.options.register,
              r = (e) =>
                v(e, (e) => {
                  const t = e.split("=");
                  return { name: t[0], text: C(t[1] || t[0]) };
                });
            t("export_formats", {
              processor: (e) =>
                ((e, t) => {
                  if (a(e)) {
                    for (let r = 0, o = e.length; r < o; ++r) if (!t(e[r])) return !1;
                    return !0;
                  }
                  return !1;
                })(e, i)
                  ? { value: r(e), valid: !0 }
                  : i(e)
                    ? { value: r(e.split(/[\s,]+/)), valid: !0 }
                    : { valid: !1, message: "Must be a string or an array of strings." },
              default: "clientpdf",
            }),
              t("export_ignore_elements", { processor: "string[]", default: [] }),
              t("export_image_proxy", { processor: "string" }),
              t("export_image_proxy_service_url", { processor: "string" }),
              t("export_image_proxy_max_in_flight", { processor: "number", default: 5 }),
              t("export_cors_hosts", { processor: "string[]" }),
              t("export_api_key", { processor: "string" });
          })(e),
          ((e, t) => {
            const r = v(T(e), (r) => ({
              type: "menuitem",
              text: r.text,
              onAction: () => {
                H(e, t, r.name, () => Promise.resolve({}));
              },
            }));
            e.ui.registry.addMenuButton("export", { icon: "export", tooltip: "Export", fetch: (e) => e(r) }),
              e.ui.registry.addNestedMenuItem("export", { text: "Export", icon: "export", getSubmenuItems: p(r) });
          })(e, r),
          ((e, t) => {
            e.addCommand("mceExportDownload", (r, o) => {
              const n = y.from(o.settings).getOr({});
              H(e, t, o.format, () => Promise.resolve(n));
            });
          })(e, r),
          ((e, t) => ({
            convert: (r, o) => K(e, t, r).then((e) => e.convert(o)),
            download: (r, o) => {
              K(e, t, r).then((e) => {
                e.download(o);
              });
