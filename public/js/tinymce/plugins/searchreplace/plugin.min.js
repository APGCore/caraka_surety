...
!(function () {
    ...
    const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
                        ...
                        return ((e, t) => {
                            ...
                            v(
                                ...
                                ((e, t) => {
                                    ...
                                    return (1 !== (o = n).nodeType && 9 !== o.nodeType && 11 !== o.nodeType) ||
        ...
        J = (e, t, n) => {
            ...
            const a = H(e, r);
            return a.length
                ? (s.addClass(H(e, r), "mce-match-marker-selected"), e.selection.scrollIntoView(a[0]), r)
                : -1;
        },
        L = (e, t) => {
        ...
        ee = (e, t, n, o, r) => {
            ...
            return (
                t.set({ ...s, count: r ? 0 : s.count - 1, index: i }), o ? X(e, t) : Y(e, t), !r && t.get().count > 0
            );
        },
        te = (e, t, n) => {
            let o, r;
            ...
            const r = f.trim(t.selection.getContent({ format: "text" })),
                ...
                d = (e) => {
                    ...
                    if (o.findtext.length) {
                        if (r.text === o.findtext && r.matchCase === o.matchcase && r.wholeWord === o.wholewords)
                            X(t, n);
                        else {
