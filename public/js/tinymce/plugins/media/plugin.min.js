...
!(function () {
            ...
            for (let a = A({ validate: !1, forced_root_block: !1 }, t).parse(e); a; a = a.walk())
                if (1 === a.type) {
                    ...
                    r.source || "param" !== e || (r.source = a.attr("movie")),
                        ...
                        "source" === e &&
                            (r.source ? r.altsource || (r.altsource = a.attr("src")) : (r.source = a.attr("src"))),
                        "img" !== e || r.poster || (r.poster = a.attr("src"));
                }
            return (
                (r.source = r.source || r.src || ""), (r.altsource = r.altsource || ""), (r.poster = r.poster || ""), r
            );
        },
        $ = (e) => {
            var t;
    ...
    const F = (e, t = {}) => A({ forced_root_block: !1, validate: !1, allow_conditional_comments: !0, ...t }, e),
                    ...
                    if (r)
                        switch (a) {
                            ...
                            case "source":
                                if (
                                    s < 2 &&
                                    (e.attr("src", t[P[s]]), e.attr("type", t[P[s] + "mime"] || null), !t[P[s]])
                                ) {
                                    e.remove();
                                    continue;
                                }
        ...
        B = (e, t) => {
            var r;
            const a = k.extend({}, t);
            if (!a.source && (k.extend(a, T(null !== (r = a.embed) && void 0 !== r ? r : "", e.schema)), !a.source))
                return "";
        ...
        H = (e, t) => {
            ...
            return r
                ? ((e, t, r) =>
                      new Promise((a, o) => {
                          const s = (r) => (
                              r.html && (W[e.source] = r), a({ url: e.source, html: r.html ? r.html : t(e) })
                          );
            ...
            e.insertContent(t),
                ((e, t) => {
                    ...
                    for (let e = 0; e < t.length; e++)
                        for (let a = r.length - 1; a >= 0; a--) t[e] === r[a] && r.splice(a, 1);
        ...
        Z = (e) => {
            ...
            x(e) && i.push({ name: "altsource", type: "urlinput", filetype: "media", label: "Alternative source URL" }),
                _(e) &&
                    i.push({ name: "poster", type: "urlinput", filetype: "image", label: "Media poster (Image URL)" });
                        ...
                        switch (a.name) {
                            case "source":
                                ((t, r) => {
                                    ...
                                    t.source !== a.source &&
                                        (X(u, e)({ url: a.source, html: "" }), H(e, a).then(X(u, e)).catch(V(e)));
                                })(r.get(), t);
                                break;
                            case "embed":
                                ((t) => {
