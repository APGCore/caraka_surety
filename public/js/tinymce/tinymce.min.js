...
!(function () {
        ...
        Ls = (e = {}) => {
            ...
            e.valid_elements
                ...
                : (Ns(d, (e, t) => {
                  ...
                  Ns(x, (t, o) => {
                      n[o] &&
                          (e.padd_empty_block_inline_children && (n[o].paddInEmptyBlock = !0), (n[o].removeEmpty = !0));
                  }),
            ...
            const a = Jo.forElement(mn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
                ...
                G = {
                    ...
                    select: (n, o) => {
                        var r, s;
                        const a =
                            null !== (s = null !== (r = f(o)) && void 0 !== r ? r : t.root_element) && void 0 !== s
                                ? s
                                : e;
                    ...
                    (n = ((e) => {
                        const t = [],
                            ...
                            o = (e, t) => {
                                ...
                                if (t < e.data.length) {
                                    ...
                                    if (Ha(e.data[t - 1]) && (o.setStart(e, t), o.setEnd(e, t + 1), !ni(o)))
                                        return void n(si(ri(o), !1));
                                }
                                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), ni(o) || n(si(ri(o), !1))),
                                    t < e.data.length &&
                                        (o.setStart(e, t), o.setEnd(e, t + 1), ni(o) || n(si(ri(o), !0)));
                            },
                            r = e.container(),
                            s = e.offset();
                        ...
                        if ($a(r))
                            if (e.isAtEnd()) {
                                ...
                                Ka(i) && !Xa(i) && (qa(i) || qa(a) || !Ka(a)) && n(si(ri(i), !1)),
                                    Ka(a) && n(si(ri(a), !0));
                            }
                        return t;
                    })(ai(e, t))),
    ...
    const ii = (e, t) => {
        ...
        mi = (e) => {
            ...
            e
                ? Oe(e.childNodes, (e, t) => (ci(t) && "BR" !== t.nodeName ? (e = e.concat(fi(t))) : e.push(t), e), [])
                : [],
        gi = (e) => (t) => e === t,
        pi = (e) =>
            ...
            return {
                show: (e, c) => {
                        ...
                        );
                    {
                        const n = ((e, t, n) => {
                                var o;
                                const r = (null !== (o = t.ownerDocument) && void 0 !== o ? o : document).createElement(
                                    e,
                                );
        ...
        Qu = (e, t, n, o, r) => {
            ...
            for (let o = 0; o < a.length; o++)
                for (let r = 0; r < t.length; r++) {
                    const s = t[r];
                    if ((!C(s.collapsed) || s.collapsed === n.collapsed) && Uu(s) && e.is(a[o], s.selector))
                        return a[o];
                }
            return o;
        },
        ...
        em = (e, t, n, o, r) => {
            ...
            for (; s; ) {
                ...
                for (let t = s[a]; t; t = t[a]) {
                    ...
                    if (!Hu(t) && (!Po((l = t)) || !l.getAttribute("data-mce-bogus") || l.nextSibling) && !Vu(t, n))
                        return s;
                }
            ...
            ((e, t) => {
                const n = pa(),
                    ...
                    r = (e) => {
                        ...
                        V(o, (t) => e.attr(t, null));
                        const s =
                                null !== (n = null === (t = e.attr("class")) || void 0 === t ? void 0 : t.split(" ")) &&
                                void 0 !== n
                                    ? n
                                    : [],
                            a = oe(s, [ga()].concat(r));
        ...
        Rm = document.caretPositionFromPoint
            ...
            : document.caretRangeFromPoint
              ? (e, t, n) => {
                    var o, r;
                    return M.from(
                        null === (r = (o = e.dom).caretRangeFromPoint) || void 0 === r ? void 0 : r.call(o, t, n),
                    );
                }
              : M.none,
            ...
            ((e, t, n) =>
                ((e, t, n) => {
                    ...
                    return Rm(o, t, n).map((e) =>
                        Nm(mn(e.startContainer), e.startOffset, mn(e.endContainer), e.endOffset),
                    );
        ...
        If = (e) =>
            e.inline
                ? ((e) => {
                      ...
                      return (
                          t &&
                          ((n = mn(t)), vf(n) || ((o = n), yf(Ln(o)).filter((e) => o.dom.contains(e.dom))).isSome())
                      );
                      var n, o;
                  })(e)
    ...
    const dg = ["font", "text-decoration", "text-emphasis"],
            ...
            ((e, t, n) =>
                e
                    ? ((e, t) =>
                          dp(t)
                              .orThunk(() => lp(t))
                              .orThunk(() => ((e, t) => Lc(e, ai.after(t)).orThunk(() => Mc(e, ai.before(t))))(e, t)))(
                          t,
                          n,
                      )
                    : ((e, t) =>
            ...
            const i = ((e, t, n) => {
                ...
                return (
                    ...
                    s.isSome() && a.isSome() && i.isSome()
                        ...
                        : M.none()).orThunk(
                        () => (n && (o.each((e) => sp(e.dom, e.dom.length)), r.each((e) => rp(e.dom, 0))), t),
                    )
                );
                var s, a, i, l;
        ...
        Np = (e, t, n, o = !0) => {
            ...
            if (
                (a.dom === e.getBody() ? _p(e, o) : ss(a) && (kr(a), o && e.selection.setCursorLocation(a.dom, 0)),
                !bn(n, a))
            ) {
                const e = Bt(xn(a), n)
                    ? []
                      ...
                      return 0 !== n.length
                          ...
                          : ((e, t, n, o) =>
                                Gp(t, o).fold(
                                    () =>
                                        ((e, t, n) =>
                                            Up(t, n).bind((t) => t.fold(O(qp, e), O(Wp, e), O($p, e), O(Vp, e))))(
                                            e,
                                            t,
                                            n,
                                        ),
        ...
        yh = (e, t, n) => {
            ...
            if ((e._selectionOverrides.showBlockCaretContainer(p), h.invalid)) {
                ...
                const f = b.children(),
                    g =
                        null !== (s = null === (r = b.parent) || void 0 === r ? void 0 : r.name) && void 0 !== s
                            ? s
                            : m.name;
                b.unwrap();
            ...
            return (
                ...
                ((e, t) => {
                    ...
                    if (Ro(c)) {
                        ...
                        Ro(e) &&
                            (c.appendData(e.data), null === (r = e.parentNode) || void 0 === r || r.removeChild(e));
        ...
        qh = (e, t) => {
            ...
            return p(n)
                ? Q(
                      n,
                      (e) =>
                          zu(e) && "span" === e.inline && ((e) => f(e.styles) && H(ue(e.styles), (e) => j(Vh, e)))(e),
                  )
                : M.none();
        },
                    ...
                    if (a.split) {
                        if (((r = Gm(r)), (n = db(e, r, !0)), (o = db(e, r)), n !== o)) {
                            if (((n = cb(n, !0)), (o = cb(o, !1)), lb(i, n, o))) {
                                ...
                                return (
                                    d(mb(i, e, !0, "span", { id: "_start", "data-mce-type": "bookmark" })), void m(!0)
                                );
                            }
                            if (lb(i, o, n)) {
                        ...
                        const p = (a) => {
                            ...
                            if (((o) => ((e) => Fu(e) && !0 === e.wrapper)(s) && Oh(e, o, t, n))(a)) u = null;
                                ...
                                ((t, n, r, a) => {
                                    ...
                                    ? (u || ((u = o.clone(g, !1)), w.insertBefore(u, a), l.push(u)),
                                      v && h && (m = b),
                                      u.appendChild(a))
                                  ...
                                  (s.exact ||
                                      ...
                                      (a = ((e) => {
                                          const t = Q(e.childNodes, xu).filter(
                                              (e) => "false" !== o.getContentEditable(e) && Rh(o, e, s),
                                          );
                                          return t
                                              .map((t) => {
                                                  const n = o.clone(t, !1);
                                  ...
                                  ((e, t, n, o, r) => {
                                      ...
                                      (Oh(e, s, n, o) && bb(e, t, o, r)) ||
                                          (t.merge_with_parents &&
                                              s &&
                                              e.dom.getParent(s, (s) => !!Oh(e, s, n, o) && (bb(e, t, o, r), !0)));
                                  })(e, s, t, n, a),
                                  ((e, t, n, o) => {
                                      if (t.styles && t.styles.backgroundColor) {
                                          ...
                                          tb(
                                              o,
                                              (e) => r(e) && ku(e),
                                              ob(e, "backgroundColor", Tu(t.styles.backgroundColor, n)),
                                          );
                                      }
                                  })(o, s, n, a),
                                  ((e, t, n, o) => {
                    ...
                    return e instanceof l && !Ae(e)
                        ...
                        : ("noscript" !== o && "noembed" !== o) || !tv(/<\/no(script|embed)/i, e.innerHTML)
                          ? (X &&
                                ...
                                (t = Jb(t, P, " ")),
                                e.textContent !== t &&
                                    (Yb(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
    ...
    const Wv = Tt.makeMap,
        ...
        Jv = (e, t, n) => {
            ...
            for (let t = 0, o = s.length; t < o; t++) {
                ...
                if (yo(o)) {
                    ...
                    Ro(o) ? ((a.value = o.data), r && (a.raw = !0)) : (To(o) || Ao(o) || Oo(o)) && (a.value = o.data);
                Jv(a, o, n), e.append(a);
            }
        },
        Zv = (e = {}, t = Ls()) => {
                                ...
                                return [
                                    (e) => {
                                        ...
                                        if (3 === e.type && !m(e)) {
                                            ...
                                            (n = n.replace(d, " ")),
                                                (((e, t) => C(e) && (e.name in t || "br" === e.name))(e.prev, i) ||
                                                    f(e, !0)) &&
                                                    (n = n.replace(c, "")),
                                ...
                                ((e, n) => {
                                    ...
                                    if (t.isValidChild(e.name, n.toLowerCase())) {
                                        for (; i; ) {
                                            const t = i.next;
                                            3 === i.type ||
                                            (1 === i.type && "p" !== i.name && !o[i.name] && !i.attr(Xv))
                                                ? (l ||
                                                      ((l = new Zf(n, 1)),
                        ...
                        e.addNodeFilter("br", (e, t, o) => {
                            ...
                            for (let t = 0, i = e.length; t < i; t++) {
                                ...
                                if (l && r[l.name] && i === l.lastChild) {
                                    ...
                                    let e = i;
                                    for (; l && l.firstChild === e && l.lastChild === e && ((e = l), !r[l.name]); )
                                        l = l.parent;
                                    if (e === l) {
                    ...
                    t.validate &&
                        ...
                        ((e, t) => {
                            ...
                            if (n) {
                                const t = (e) => {
                                    const t = e.attr("src");
                                    ((e) => e.attr("src") === Nt.transparentSrc || C(e.attr("data-mce-placeholder")))(
                                        e,
                                    ) ||
        ...
        yy = (e) => Nr(e.innerText),
        Cy = (e) =>
            yo(e) ? e.outerHTML : Ro(e) ? xs.encodeRaw(e.data, !1) : To(e) ? "\x3c!--" + e.data + "--\x3e" : "",
        wy = (e, t) => (
            ((e, t) => {
                let n = 0;
                V(e, (e) => {
        ...
        Ty = (e) => ({
            ...
            undoManager: {
                ...
                hasUndo: (t, n) =>
                    ((e, t, n) => n.get() > 0 || (t.typing && t.data[0] && !Ny(ky(e), t.data[0])))(e, t, n),
                    ...
                    ((e, t) => {
                        ...
                        return M.from(e.selection.getStart(!0))
                            .bind((o) =>
                                Sh(
                                    mn(o),
                                    (n) => ce(t, (t) => ((t, n) => (Oh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)),
                                    n,
                                ),
                            )
                            .getOrNull();
            ...
            editor: {
                getContent: (t) =>
                    ((e, t) =>
                        M.from(e.getBody()).fold(N("tree" === t.format ? new Zf("body", 11) : ""), (n) => rg(e, t, n)))(
                        e,
                        t,
                    ),
                setContent: (t, n) =>
        ...
        Iy = (e, t, n, o) => {
            e.bind(
                ...
                const e = ((e, t) => e.filter((e) => dm.isBookmarkNode(e.dom)).bind(t ? Sn : kn))(t, o)
                    .or(t)
                    .filter(Ut);
                return e.map((e) =>
                    ((e, t) => {
            ...
            const { selectorChangedWithUnbind: a } = ((e, t) => {
                ...
                c = () => {
                    ...
                    try {
                        ...
                        e &&
                            !vo(e.anchorNode) &&
                            ((n = e.rangeCount > 0 ? e.getRangeAt(0) : i.createRange()), (n = $f(o, [n])[0]));
                    } catch (e) {}
                ...
                f = {
                    ...
                    getContent: (e) =>
                        ((e, t = {}) =>
                            ((e, t, n) => Py(e).selection.getContent(t, n))(e, t.format ? t.format : "html", t))(o, e),
                    setContent: i,
                            ...
                            M.from(t).bind((t) =>
                                M.from(t.parentNode).map((o) => {
                                    const r = e.nodeIndex(t),
                                        s = e.createRng();
                                    return (
                                        s.setStart(o, r), s.setEnd(o, r + 1), n && (bu(e, s, t, !0), bu(e, s, t, !1)), s
                                    );
                                }),
                            ))(e, t, n).each(u),
                        t
                                              ...
                                              ze(o, "blob:")
                                                  ...
                                                  : ze(o, "data:")
                                                    ? ((r = o),
                                                      new Promise((e, t) => {
                                                          Bv(r)
                                                              .bind(({ type: e, data: t, base64Encoded: n }) =>
                                                                  Dv(e, t, n),
                                                              )
            ...
            const r = bC(),
                ...
                i = (e, t, n) => {
                    ...
                    do {
                        (o = e.indexOf(t, o)),
                            -1 !== o &&
                                ((e = e.substring(0, o) + n + e.substr(o + t.length)), (o += n.length - t.length + 1));
                    } while (-1 !== o);
                    return e;
                },
                l = (e, t, n) => {
        ...
        DC = (e) => {
            ...
            return (
                    ...
                    })(n, e),
                {
                    ...
                    matchNode: (t, n, o, r) =>
                        ((e, t, n, o, r) => Py(e).formatter.matchNode(t, n, o, r))(e, t, n, o, r),
        ...
        LC = (e) => {
            const t = ua(),
                ...
                r = {
                    ...
                    add: (s, a) =>
                        ((e, t, n, o, r, s, a) => Py(e).undoManager.add(t, n, o, r, s, a))(e, r, o, n, t, s, a),
                    dispatchChange: () => {
                        e.setDirty(!0);
                        const t = ky(e);
                                                ...
                                                : cw(e, t, n).bind((t) =>
                                                      ((e, t, n) =>
                                                          n.fold(
                                                              ...
                                                              (n) =>
                                                                  oc(t, n, e) ? M.none() : M.some(dw.moveToPosition(n)),
                                                          ))(e, n, t),
                                                  ))(e, t, r);
                        })(e.getBody(), t, e.selection.getRng()).map(
                            (n) => () =>
                                n.fold(
                                    ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), gp(e, t, mn(n)), !0))(
                                        e,
                                        t,
                                    ),
                                    ((e, t) => (n) => {
    ...
    const mx = (e, t, n, o, r, s) => {
        ...
        Kx = (e, t) => {
            ...
            const { dom: r } = e,
                s = yl(e),
                a =
                    null !== (o = null === (n = /[a-z%]+$/i.exec(s)) || void 0 === n ? void 0 : n[0]) && void 0 !== o
                        ? o
                        : "px",
                i = Hx(s),
                l = vl(e);
        ...
        Bk = (e, t = !1) => {
            return zn(e)
                ...
                : ((n = e), Xo(n, "[contenteditable]")).fold(N(t), (e) => "true" === Dk(e));
            var n;
        },
    ...
    const uS = (e, t, n) => (e.stype === cS.Error ? t(e.serror) : n(e.svalue)),
                            ...
                            we(n, o).fold(
                                () =>
                                    ((e, t, n) =>
                                        hS(
                                            e,
                                            () => 'The chosen schema: "' + n + '" did not exist in branches: ' + pS(t),
                                        ))(e, n, o),
                    ...
                    e.fold(
                        ...
                        (e) => {
                            ...
                            return (
                                (s = n),
                                (a = M.some),
                                s.stype === cS.Value ? { stype: cS.Value, svalue: a(s.svalue) } : s
                            );
                            var s, a;
                        },
                    );
                ...
                case "required":
                    return ((e, t, n, o) =>
                        we(t, n).fold(
                            () =>
                                ((e, t, n) =>
                                    hS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + pS(n)))(
                                    e,
                                    n,
                                    t,
                                ),
        ...
        AS = (e, t, n) => {
            return (
                (o = ((e, t, n) =>
                    ((e, t) => (e.stype === cS.Error ? { stype: cS.Error, serror: t(e.serror) } : e))(
                        t.extract([e], n),
                        (e) => ({
                            input: n,
                            errors: e,
                ...
                ((e) => {
                    return (
                        (t = (t) =>
                            j(e, t)
                                ? Oi.value(t)
                                : Oi.error(`Unsupported value: "${t}", choose one of "${e.join(", ")}".`)),
                        kS((e) => t(e).fold(fS, mS))
                    );
                    var t;
                })(n),
                        ...
                        t
                            ...
                            .getOrThunk(() =>
                                ((e, t) => {
                                    const n = t(),
                                        o = e.selection.getRng();
                                    return ((e, t, n) => ce(n.triggers, (n) => aS(e, t, n)))(e.dom, o, n).bind((n) =>
                                        dS(e, t, n),
                                    );
                                })(e, s),
                            ))(a).fold(r, (s) => {
            ...
            insert: (e, t) => {
                ...
                const i = e.dom,
                    ...
                    g = (e) => {
                        ...
                        let s;
                        for (
                            Ro(n) && (e && 0 === t ? r.prev() : e || t !== n.data.length || r.next());
                            (s = r.current());
        ...
        mE = (e) => {
            ...
            if (e.selection.isCollapsed()) {
                ...
                return Mw(o, e.getBody(), r)
                    ...
                    .map(
                        (o) => () =>
                            uE(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e)),
                    );
            }
            return M.none();
        },
                    ...
                    ((e, t) => {
                        e.on("keydown", (n) => {
                            n.isDefaultPrevented() ||
                                ((e, t, n) => {
                                    const o =
                                        n.keyCode === bm.BACKSPACE ? "deleteContentBackward" : "deleteContentForward";
                                    xk(
                                        [
                            ...
                            t.isDefaultPrevented() ||
                                ((e, t) => {
                                    xk([{ keyCode: bm.SPACEBAR, action: Ck(mE, e) }], t).each((n) => {
                                        t.preventDefault(),
                                            w_(e, "insertText", { data: " " }).isDefaultPrevented() ||
    ...
    const hE = N("x-tinymce/html"),
        ...
        VE = (e) =>
            !e.selection.isCollapsed() ||
            ((e) =>
                !!e.dom.getParent(e.selection.getStart(), "td[data-mce-selected],th[data-mce-selected]", e.getBody()))(
                e,
            ),
        qE = (e, t) => {
            var n, o;
                ...
                return ((e, t, n, o) => {
                    const r = (t, s) =>
                        s
                            ...
                            .orThunk(() => {
                                var n;
                                return (bn(t, e) ? M.none() : ((n = t), M.from(n.dom.parentElement).map(mn))).bind(
                                    (e) => r(e, M.some(t)),
                                );
                            });
                    return r(t, M.none());
                                    ...
                                    const t = (t) => {
                                            if (!t.isDefaultPrevented()) {
                                                ...
                                                n &&
                                                    ...
                                                    (t.preventDefault(),
                                                    "drop" === t.type && cC(e, "Dropped file type is not supported"));
                                            }
                                        },
                                        n = (n) => {
                                            Bf(e, n.target) && t(n);
        ...
        VN = (e, t, n, o) => {
            ...
            return eS(i, l - n.pattern.end.length, t).bind((d) => {
                ...
                if (HN(a)) return M.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
                {
                    ...
                    return m.map((e) => {
                        const t = ((e, t, n, o = !1) =>
                            AN(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(r, s, e, o);
                        return {
                            ...
                            const t = [",", ".", ";", ":", "!", "?"],
                                ...
                                o = () => {
                                    return (
                                        (t = yd(e)),
                                        (n = Cd(e)),
                                        { inlinePatterns: Mi(t), blockPatterns: Li(t), dynamicPatternsLookup: n }
                                    );
                                    var t, n;
                                },
                            ...
                            if (
                                ((e) => {
                                    if (FC(e)) {
                                        ...
                                        return (
                                            !UC(e) &&
                                            (bm.metaKeyPressed(e) || e.altKey || (t >= 112 && t <= 123) || j(MC, t))
                                        );
                                    }
                                    return !1;
                                })(t)
                ...
                .bind((n) =>
                    ((e, t, n) =>
                        Sh(
                            mn(n),
                            (t) =>
                                ((t) => Wn(t, e).orThunk(() => (OR(t) ? we(AR, e).bind((e) => Kt(t, e)) : M.none())))(
                                    t,
                                ),
                            (e) => bn(mn(t), e),
                ...
                : VR(e) &&
                  ((e, t) => {
                      if (((e) => "click" === e.type)(t) && !bm.metaKeyPressed(t)) {
                          const n = mn(t.target);
                          ((e, t) => Xo(t, "a", (t) => bn(t, mn(e.getBody()))).bind((e) => Kt(e, "href")))(e, n).each(
                              (n) => {
                ...
                "focus" !== e &&
                    ...
                    (n.removed ||
                        (t
                            ...
                            : n.initialized &&
                              n.delegates &&
                              (n.dom.unbind(ZR(n, e), e, n.delegates[e]), delete n.delegates[e])));
            },
            ...
            ((e) => {
                ...
                e.on("remove", () => {
                    ...
                    (e.ui.styleSheetLoader = ((e, t) =>
                        Jo.forElement(e, { contentCssCors: Gl(t), referrerPolicy: pl(t) }))(o, e)),
                    zl(e)
                        ? (e.inline = !0)
