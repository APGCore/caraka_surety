...
!(function () {
  ...
  const ii = (e, t) => {
    ...
    Ci = (e, t, n) => {
      let o = 0;
      return (
        Tt.each(e.select(t), (e) => ("all" === e.getAttribute("data-mce-bogus") ? void 0 : e !== n && void o++)), o
      );
    },
    wi = (e, t) => {
    ...
    mE = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return Mw(o, e.getBody(), r)
          ...
          .map(
            (o) => () => uE(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e)),
          );
      }
      return M.none();
    },
    ...
    render() {
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) => Jo.forElement(e, { contentCssCors: Gl(t), referrerPolicy: pl(t) }))(
            o,
            e,
          )),
          zl(e)
