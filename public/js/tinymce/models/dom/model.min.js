...
!(function () {
    ...
    const at = (e, t, o) => {
        ...
        jt = (e, t) =>
            ((e, t, o = y) =>
                o(t) ? C.none() : D(e, Z(t)) ? C.some(t) : ct(t, e.join(","), (e) => we(e, "table") || o(e)))(
                ["td", "th"],
                e,
                t,
            ),
    ...
    const Hr = (e, t, o, n) => {
        ...
        gl = (e, t, o, n, r) => {
            ((e, t, o, n) => {
                ...
                if (t > 0 && t < r.length) {
                    const e = ((e, t) =>
                        W(e, (e, o) => (O(e, (e) => t(e.element, o.element)) ? e : e.concat([o])), []))(
                        r[t - 1].cells,
                        o,
                    );
                    N(e, (e) => {
        ...
        Nl = (e) =>
            W(e, (e, t) => (O(e, (e) => e.column === t.column) ? e : e.concat([t])), []).sort(
        ...
        ql = (e) => {
            const t = ae("br"),
                        ...
                        .bind((o) => {
                            const n = ke(o)
                                .map(
                                    (e) =>
                                        !!Fl(e) ||
                                        (!!((e, t) => D(["br", "img", "hr", "input"], e.property().name(t)))(Pl, e) &&
                                            "img" !== Z(e)),
                                )
                                .getOr(!1);
                            return Re(o).map((r) => {
                ...
                n = (() => {
                    const n = j(e, (e) => {
                        const n = Ee(e);
                        return ((e) => I(e, (e) => t(e) || (re(e) && 0 === cr(e).trim().length)))(n)
                            ? []
                            : n.concat(o(e));
                    });
        ...
        Kl = (e) =>
            W(e, (e, t) => (O(e, (e) => e.row === t.row) ? e : e.concat([t])), []).sort((e, t) => e.row - t.row),
        Yl = (e, t) => (o, n, r, s, l) => {
            const a = Kl(n),
                c = E(a, (e) => e.row),
                i = ((e, t, o, n, r, s, l) => {
                    ...
                    const f = [...a, ...u],
                        g = ((e, t) => (I(t, h) && Rs(e.cells) ? x : (e, o, n) => !("th" === Z(e.element) && t[n])))(
                            i,
                            d,
                        ),
                        p = (
        ...
        da = Js(
            (e, t, o, n) => {
                const r = t.details,
                    ...
                    a = A(
                        s,
                        (e, t) => ({ grid: pl(e.grid, l, t.column + e.delta, o, n.getOrInit), delta: e.delta + 1 }),
                        {
                            grid: e,
                            delta: 0,
                        },
        ...
        Ta = Js(
            ...
            (e, t) =>
                jt(t.element).bind((o) =>
                    Ks(e, o).map((e) => ({ ...e, generators: t.generators, clipboard: t.clipboard })),
                ),
            ea,
            f,
            _l,
        ...
        Tc = (e, t, o, n, s) => {
            const l = ((e) => {
                    ...
                    return t.isSet("table_default_styles")
                        ? o
                        : ((e, t) => (Ya(e) || !Qa(e) ? t : Ka(e) ? { ...t, width: Pa(e) } : { ...t, width: Ia }))(
                              e,
                              o,
                          );
                })(e),
                    ...
                    .map(
                        (t) => (
                            Ka(e)
                                ...
                                : Ya(e)
                                  ? yc(t)
                                  : (Ga(e) || ((e) => r(e) && -1 !== e.indexOf("%"))(l.width)) && bc(t),
                            kr(t),
                            fe(t, "data-mce-id"),
                            ((e, t) => {
                                N(st(t, "tr"), (t) => {
                    ...
                    o().each((o) => {
                        ...
                        l((o, r) => {
                            const s = Rr(pe.fromDom(e.getDoc())),
                                l = ((e, t, o, n) => ({ selection: Zr(e), clipboard: o, generators: n }))(
                                    as(e),
                                    0,
                                    n,
                                    s,
                        ...
                        jc(e).each((t) => {
                            Ft(t, o).each((o) => {
                                it(o, "caption").fold(
                                    ...
                                    (n) => {
                                        ae("caption")(t) &&
                                            ve("td", o).each((t) => e.selection.setCursorLocation(t.dom, 0)),
                                            Ie(n);
                                    },
                                ),
                                    Wa(e, o.dom, _a);
    ...
    const Zc = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
        ...
        ni = (e, t, o, n, r) =>
            ye(o, n)
                ...
                : Gr(o, n, t).bind((t) => {
                      ...
                      return n.length > 1
                          ? (r(e, n, t.start, t.finish), C.some(Hc(C.some(oi(o, 0, o, dr(o))), !0)))
                          : C.none();
                  }),
        ...
        mi = (e, t, o, n, r, s) =>
            ii(e, t, n, r).bind((t) =>
                s(t.item) ? C.none() : o(t.item) ? C.some(t.item) : mi(e, t.item, o, t.mode, r, s),
            ),
            ...
            dt(e, "tr", t).bind((e) =>
                dt(e, "table", t).bind((o) => {
                    ...
                    return ye(e, n[n.length - 1])
                        ? ((e, t, o) => fi(gi, e, (e) => gr(e).isSome(), o))(o, 0, t).map((e) =>
                              Hc(C.some(oi(e, 0, e, 0)), !0),
                          )
                        : C.none();
                }),
            ),
        ...
        sm = document.caretPositionFromPoint
            ...
            : document.caretRangeFromPoint
              ? (e, t, o) => {
                    var n, r;
                    return C.from(
                        null === (r = (n = e.dom).caretRangeFromPoint) || void 0 === r ? void 0 : r.call(n, t, o),
                    );
                }
              : C.none,
        lm = (e, t) => {
                                        ...
                                        g = Kr(t, n.selectedSelector).fold(
                                            ...
                                            (e) => {
                                                const o = (o) => () => {
                                                    ...
                                                    return s.fold(
                                                        () =>
                                                            Yr(t, n.firstSelectedSelector, n.lastSelectedSelector).map(
                                                                (e) => {
                                                                    const o =
